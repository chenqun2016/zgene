...
public class GetuiflutPlugin implements MethodCallHandler, FlutterPlugin {
  ...
  public static void registerWith(Registrar registrar) {
    ...
    channel.setMethodCallHandler(new GetuiflutPlugin());
  }
  ...
  @Override
  public void onAttachedToEngine(@NonNull @org.jetbrains.annotations.NotNull FlutterPlugin.FlutterPluginBinding flutterPluginBinding) {
  ...
  @Override
  public void onDetachedFromEngine(@NonNull @org.jetbrains.annotations.NotNull FlutterPlugin.FlutterPluginBinding flutterPluginBinding) {
